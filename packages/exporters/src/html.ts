import { buildStandaloneDocument } from '@dsr-codesign/runtime';
import { LEGACY_SOURCE_ENTRY } from '@dsr-codesign/shared';
import {
  findHtmlStartTag,
  getHtmlAttribute,
...
export function buildHtmlDocument(artifactSource: string, opts: ExportHtmlOptions = {}): string {
  ...
  const banner =
    opts.bannerComment ?? 'Generated by dsr-codesign — https://github.com/DSR-AI-Lab/dsr-codesign';
  ...
  out = injectIntoHead(out, `<meta name="generator" content="dsr-codesign" />`);
  out = `<!-- ${banner} -->\n${out}`;
...
<title>dsr-codesign export</title>
</head>
<body>
${trimmed}
</body>
