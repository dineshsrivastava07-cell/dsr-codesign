...
const releasesBase = `https://github.com/DSR-AI-Lab/dsr-codesign/releases/download/v${latestVersion}`;

type Asset = { label: string; file: string; size: string; url: string };

const macArm: Asset = {
  label: 'macOS · Apple Silicon',
  file: `dsr-codesign-${latestVersion}-arm64.dmg`,
  size: '135 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-arm64.dmg`,
};
const macIntel: Asset = {
  label: 'macOS · Intel',
  file: `dsr-codesign-${latestVersion}-x64.dmg`,
  size: '140 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-x64.dmg`,
};
const winX64: Asset = {
  label: 'Windows · x64',
  file: `dsr-codesign-${latestVersion}-x64-setup.exe`,
  size: '~110 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-x64-setup.exe`,
};
const winArm: Asset = {
  label: 'Windows · ARM64',
  file: `dsr-codesign-${latestVersion}-arm64-setup.exe`,
  size: '~100 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-arm64-setup.exe`,
};
const linuxAppImage: Asset = {
  label: 'Linux · AppImage (x64)',
  file: `dsr-codesign-${latestVersion}-x64.AppImage`,
  size: '~140 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-x64.AppImage`,
};
const linuxSnap: Asset = {
  label: 'Linux · Snap (x64)',
  file: `dsr-codesign-${latestVersion}-x64.snap`,
  size: '~140 MB',
  url: `${releasesBase}/dsr-codesign-${latestVersion}-x64.snap`,
};
...
const xattrCmd = 'xattr -cr "/Applications/DSR CoDesign.app"';
