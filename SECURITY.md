...
1. Go to https://github.com/DSR-AI-Lab/dsr-codesign/security/advisories/new
...
For urgent or sensitive matters, you may also email **security@dsrailab.com** (PGP key TBD).
